...
import calendar.tools.droid.interfaces.WeekFragmentListener
import calendar.tools.droid.interfaces.WeeklyCalendar
import calendar.tools.droid.models.Event
import calendar.tools.droid.models.EventWeeklyView
import calendar.tools.droid.views.MyScrollView
...
class WeekFragment : Fragment(), WeeklyCalendar {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mView = inflater.inflate(R.layout.fragment_week, container, false).apply {
            ...
            //week_horizontal_grid_holder display Grid structure to display border of Grid
    ...
    //TODO EVENTS WEEK VIEW ME YAHAN ADD HO RAHE HAIN
