...
class EventActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mDialogTheme = getDialogTheme() // theme use for date and time picker
        ...
        ensureBackgroundThread {
            ...
            event_label.setOnClickListener{
                Toast.makeText(this@EventActivity,"Email is clicked...",Toast.LENGTH_LONG).show()
            }
            user_email.setOnClickListener {
                event_label.performClick()
            }
        }
    }
    ...
    private fun setupStartDate() {
        ...
        val datepicker = DatePickerDialog(this, R.style.DialogThemePicker, startDateSetListener, mEventStartDateTime.year, mEventStartDateTime.monthOfYear - 1,
            mEventStartDateTime.dayOfMonth)
    ...
    private fun setupStartTime() {
        ...
        TimePickerDialog(this, R.style.DialogThemePicker, startTimeSetListener, mEventStartDateTime.hourOfDay, mEventStartDateTime.minuteOfHour, config.use24HourFormat).show()
    }
    ...
    private fun setupEndDate() {
        ...
        val datepicker = DatePickerDialog(this, R.style.DialogThemePicker, endDateSetListener, mEventEndDateTime.year, mEventEndDateTime.monthOfYear - 1,
            mEventEndDateTime.dayOfMonth)
    ...
    private fun setupEndTime() {
        ...
        TimePickerDialog(this, R.style.DialogThemePicker, endTimeSetListener, mEventEndDateTime.hourOfDay, mEventEndDateTime.minuteOfHour, config.use24HourFormat).show()
    }
