...
import calendar.tools.droid.dialogs.SetRemindersDialog
import calendar.tools.droid.extensions.*
import calendar.tools.droid.fragments.*
import calendar.tools.droid.helpers.*
import calendar.tools.droid.helpers.Formatter
import calendar.tools.droid.jobs.CalDAVUpdateListener
...
class TestWeekCalendar  : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_test_week_calendar)
    ...
    private fun getFragmentsHolder() = WeekFragmentsHolder()/*when (config.storedView) {
