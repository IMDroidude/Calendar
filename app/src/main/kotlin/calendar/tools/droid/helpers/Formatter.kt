...
object Formatter {
    ...
    fun getHoursWithMinutes(context: Context, dateTime: DateTime) = dateTime.toString(getHourWithMinutesPattern(context))
    ...
    fun getHourWithMinutesPattern(context: Context) = if (context.config.use24HourFormat) PATTERN_TIME_24 else PATTERN_TIME_12
